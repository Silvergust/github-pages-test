...
function ___syscall_symlink(target, linkpath) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(20, 0, 1, target, linkpath);
  target >>>= 0;
  linkpath >>>= 0;
  try {
